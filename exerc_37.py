...
o mais baixo, a mais gordo e o mais magro, para isto você deve fazer
...
o usuário digitar 0 (zero) no campo código. Ao encerrar o programa também
...
print('=' * 40)
print('{:=^40}'.format(" 'SENSO DA ACADEMIA' "))
print('=' * 40, '\n')
